...
export const isLocalhost = currentURL.slice(0, 8) !== "https://";
export const be_url =  isLocalhost ? "http://localhost:4321" : import.meta.env.VITE_BE_URL;
...
export const appLevelOptions = {
  ...
  gstPercentage: [5, 12, 18, 28],
  transportPaymentModes: ["Paid", "ToPay"],
  uomOptions: ["PCS", "KGS", "MTR"],
  gstUomOptions: [
    "PIECES",
    "METERS",
    "DOZEN",
