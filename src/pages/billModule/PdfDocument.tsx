    ...
    <Document>
        <Page size="A4" style={styles.page}>
            ...
            <View style={styles.header}>
                <Image
                    src="https://via.placeholder.com/50" // Placeholder for logo/image
                    style={styles.logo}
                />
                <Text style={styles.title}>Furniture Billing</Text>
                <View>
                    <Text style={styles.metadata}>Date: {new Date().toLocaleDateString()}</Text>
                    <Text style={styles.metadata}>Generated by: Your Company</Text>
                </View>
            </View>
